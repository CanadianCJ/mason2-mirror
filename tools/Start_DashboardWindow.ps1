...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        Title="Mason2 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 1 Dashboard" Height="560" Width="880" WindowStartupLocation="CenterScreen"
  ...
  <Grid Margin="16">
    ...
    <StackPanel Orientation="Horizontal" Grid.Row="0" Margin="0,0,0,8">
      ...
      <TextBlock Text="Phase 1 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â live status" FontSize="14" Opacity="0.8"/>
    </StackPanel>
...
$window.Title = "Mason2 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Phase 1 Dashboard (" + $mode + ")"
...
function Paint([hashtable]$s){
  ...
  $StampText.Text    = "Integrity: $($s.integrity) ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Phase1 Accepted: $($s.phase_accept) ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Full Applied: $($s.phase_full)"
  ...
  $AlertText.Text = ("Anomaly: {0}  ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢  Drift: {1}  ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢  Stuck: {2}" -f $s.alerts.anomaly,$s.alerts.drift,$s.alerts.stuck)
